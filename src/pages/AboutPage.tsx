...
const ORIGIN_STORY = [
  "Arizona Product Destruction has been dismantling and processing product in the Valley for over two decades, but it hasn't always looked like it does today. APD started life under a company called Recycle One (also known as Arizona Pacific Paper). Beth Williamson spent almost two decades working at Recycle One, learning the recycling and destruction industry inside and out. Back then, product destruction was a narrow, standard operation focused almost entirely on paper. In 2021, the owner of Recycle One sold off the three divisions separately one of which became Arizona Product Destruction, purchased by Williamson. It was only once she took the reins that the division began the growth it enjoys today.",
  "For APD's first two and a half to three years under Williamson's ownership, beverage and psyllium destruction made up roughly 90% of the business, most of which had previously been headed straight to the landfill. From there, growth came almost entirely by Williamson's reputation for integrity in the industry with inter-market referrals. Today, that same referral-driven growth has carried APD from a single-category paper operation into a full-service destruction company handling beverages, supplements, apparel, home goods, and more. That growth has been built on people who stayed. Several members of APD's warehouse leadership worked alongside Williamson for years before APD was even part of the picture, working relationships now decades deep. That same hands-on, relationship-first approach shaped APD's certifications: it's the only Coca-Cola Certified product destruction company in Arizona, and an SBA certified Woman-Owned Small Business.",
  "That same care extends well beyond the warehouse floor. Williamson grew up in agriculture, and she's built giving back into how APD operates. The company sponsors Title One school students to attend summer camp each year, chosen through an essay or interview process. Williamson and APD supports young competitors in Arizona's junior rodeo circuit, including sponsorship of events like the Queen Creek Junior Rodeo. APD also supports agricultural programs in local schools, donates to radio station K-LOVE, and has sponsored the Circular Economy Symposium since 2023.",
]
