...
export const SERVICES: Service[] = [
  {
    ...
    description: [
      'Beverage destruction is one of our founding lines of business, and we handle it on proprietary equipment built for the job rather than routing it through a general waste stream. Cans, bottles, and multi-pack packaging are separated, crushed, and processed at our Phoenix warehouse.',
      "We hold a Coca-Cola destruction certification — the only company in Arizona with that distinction (placeholder — confirm current certification wording before publishing) — and every load closes with a Certificate of Destruction documenting volume, SKU, and disposition.",
    ],
    stats: [
  ...
  },
  {
    ...
    description: [
      'OCC arrives loose or already baled and is sorted, compacted, and staged for pickup by our recycling partners. Because this material has real resale value, our goal here is recovery rather than destruction — keeping usable fiber out of landfill while still giving you a documented chain of custody.',
      'We run this alongside our destruction lines so a single pickup can combine both material types, which keeps logistics simple for clients running mixed loads of product and packaging.',
    ],
    stats: [
